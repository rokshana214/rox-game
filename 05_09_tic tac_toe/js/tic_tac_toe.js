...
// Array に変換... もしline28でgetElementsByClassNameを使う場合は、forEachが使えないのでArrayに変換する
...
window.addEventListener("DOMContentLoaded",
    function () {
        ...
        LevelSetting(0); // levelの要素を取得「レベル設定
...
newgamebtn.addEventListener("click", function () {
    ...
    levelBox.classList.remove("js-unclickable");//levelBoxをクリックでくるようようにする
